...
export default function Home() {
  ...
  return <main>
    <header className="topbar">
      <a className="brand" href="#inicio" aria-label="Mica Nail Designer — início"><img className="brand-logo" src="/file_00000000390882469e30b6e1dbf84546.png" alt="Mica Nail Designer"/></a>
